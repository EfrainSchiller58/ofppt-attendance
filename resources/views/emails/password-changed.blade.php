                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                        ...
                        <td style="padding:0 40px;">
                            <div style="background:linear-gradient(135deg,#ecfdf5,#d1fae5);border-left:4px solid #10b981;border-radius:0 8px 8px 0;padding:16px 20px;margin-top:28px;">
                                <table cellpadding="0" cellspacing="0" width="100%"><tr>
                                    ...
                                    <td>
                                        <p style="color:#065f46;font-size:14px;font-weight:700;margin:0;">Mot de Passe Modifié</p>
                                        <p style="color:#047857;font-size:13px;margin:4px 0 0;">Votre mot de passe a été changé avec succès</p>
                                    </td>
                                </tr></table>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td style="padding:24px 40px 0;">
                            ...
                            <p style="color:#475569;font-size:14px;line-height:1.6;margin:12px 0 0;">Nous vous confirmons que votre mot de passe a été modifié avec succès.</p>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding:16px 20px;border-bottom:1px solid #e2e8f0;">
                                        <table width="100%" cellpadding="0" cellspacing="0"><tr>
                                            <td width="32"><span style="font-size:18px;">📧</span></td>
                                            <td>
                                                <p style="color:#64748b;font-size:11px;text-transform:uppercase;letter-spacing:1px;margin:0;font-weight:600;">Compte</p>
                                                <p style="color:#1e293b;font-size:15px;font-weight:600;margin:2px 0 0;">{{ $email }}</p>
                                            </td>
                                        </tr></table>
                                    </td>
                                </tr>
